...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData(){
        ...
        new NetworkWeather().execute(preferedLocation);
    }
    ...
    public class NetworkWeather extends AsyncTask<String,Void,String[]> {
        ...
        protected String[] doInBackground(String... params) {
            String locationToQuery = params[0];
            URL url = NetworkUtils.buildUrl(locationToQuery);
            ...
            String[] jsonParsedStringArray;
            try{
                jsonParsedStringArray = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, response);
            }
